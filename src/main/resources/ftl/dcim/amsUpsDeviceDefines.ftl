...
<#list amsUpsList as object>
    <DeviceDefine>
        ...
        <iSensorDefines>
            ...
            <CommonDefine>
                <name>UPS.State.Rotate.AirSwitch</name>
                <commandName>cmd_43_ups_d${object.index}_switch_state</commandName>
                <index>24</index>
                <length>2</length>
                <divider>1</divider>
            ...
            <!--电池组.2.变换器.过温 -->
            <CommonDefine>
                <name>UPS.Fault.BatteryGroup.Convertor.OverTemperature.2</name>
                <commandName>cmd_44_ups_d${object.index}_alarm_state</commandName>
                <index>88</index>
                <length>2</length>
                <divider>1</divider>
