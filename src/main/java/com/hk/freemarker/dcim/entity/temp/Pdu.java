...
public class Pdu {
    ...
    private String name = "PDU";
    private String index;
    private String lip;
    private String rip;
    private String lport = "6001";
    private String rport = "6001";
    private String lbusId;
    private String rbusId;

    public static List<Pdu> getConfig(){
//        PDU左采集IP: 71.30.0.118
        ...
        for (int i = 1; i <= 17; i++) {
            Pdu pdu = Pdu.builder().index(String.valueOf(i)).deviceId(leftDeviceId[i-1])
                    .lip("71.30.0.118").lport("6001").lbusId(String.valueOf(i * 2 - 1))
                    .rip("71.30.0.118").rport("6001").rbusId(String.valueOf(i * 2)).build();
            list.add(pdu);
        }
//        PDU右采集IP: 71.30.0.119
        ...
        for (int i = 1; i <= 17; i++) {
            Pdu pdu = Pdu.builder().index(String.valueOf(i + 17)).deviceId(rightDeviceId[i-1])
                    .lip("71.30.0.119").lport("6001").lbusId(String.valueOf(i * 2 - 1))
                    .rip("71.30.0.119").rport("6001").rbusId(String.valueOf(i * 2)).build();
            list.add(pdu);
        }
        return list;
    }
